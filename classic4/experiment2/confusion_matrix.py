...
import json
mostCommon=100
inputDirectory='../../../dataset/classic4/experiment1/selectedFeatures/'+str(mostCommon)+'Features'
resultDir='../../../dataset/classic4/experiment1/result/'+str(mostCommon)+'Features/result'
