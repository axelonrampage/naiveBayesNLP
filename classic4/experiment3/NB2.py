...
dbfile = open('../../../dataset/classic4/experiment3/frequencyRatio/training/trainingtermfrequency', 'rb')
classFerq=pickle.load(dbfile)
dbfile1 = open('../../../dataset/classic4/experiment3/frequencyRatio/testing/testingtermfrequency', 'rb')
classFerq1=pickle.load(dbfile1)

totalfrequency=classFerq+classFerq1
with open('../../../dataset/classic4/experiment3/frequencyRatio/datasettermfrequency', 'wb') as dp:
